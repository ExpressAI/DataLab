...
"""
_DESCRIPTION = """\
Named entity recognition aims to recognize various entities, including diseases, drugs, syndromes, etc. The cMedQANER dataset is labeled from Chinese community question answering.
"""
_HOMEPAGE = "https://github.com/alibaba-research/ChineseBLUE/"
_LICENSE = "Available for research use"

_TRAIN_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/ner/cMedQANER/train.txt"
_VALIDATION_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/ner/cMedQANER/dev.txt"
_TEST_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/ner/cMedQANER/test.txt"


class cMedQANER(datalabs.GeneratorBasedBuilder):
