...
class CrossSumDataset(datalabs.GeneratorBasedBuilder):
    ...
    _LANG = ["am", "ar", "az", "bn", "my", "zh-CN", "zh-TW", "en", "fr", "gu", "ha", "hi", "ig", "id", "ja",
             "rn", "ko", "ky", "mr", "np", "om", "ps", "fa", "pcm", "pt", "pa", "ru", "gd", "sr-C", "sr-L", "si",
             "so", "es", "sw", "ta", "te", "th", "ti", "tr", "uk", "ur", "uz", "vi", "cy", "yo"]
    _LANG_NAME = {
        "am": "amharic", "ar": "arabic", "az": "azerbaijani",
        "bn": "bengali", "my": "burmese", "zh-CN": "chinese_simplified",
        "zh-TW": "chinese_traditional", "en": "english", "fr": "french",
        "gu": "gujarati", "ha": "hausa", "hi": "hindi",
        "ig": "igbo", "id": "indonesian", "ja": "japanese",
        "rn": "kirundi", "ko": "korean", "ky": "kyrgyz",
        "mr": "marathi", "np": "nepali", "om": "oromo",
        "ps": "pashto", "fa": "persian", "pcm": "pidgin",
        "pt": "portuguese", "pa": "punjabi", "ru": "russian",
        "gd": "scottish_gaelic", "sr-C": "serbian_cyrillic", "sr-L": "serbian_latin",
        "si": "sinhala", "so": "somali", "es": "spanish",
        "sw": "swahili", "ta": "tamil", "te": "telugu",
        "th": "thai", "ti": "tigrinya", "tr": "turkish",
        "uk": "ukrainian", "ur": "urdu", "uz": "uzbek",
        "vi": "vietnamese", "cy": "welsh", "yo": "yoruba"
    }
    ...
    BUILDER_CONFIGS = list(CrossSumConfig(
        name=l2l,
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datalabs.SplitGenerator(
                ...
                gen_kwargs={
                    "f_path": os.path.join(f_path, "dataset_CrossSum/{}-{}_train.jsonl".format(src_lang, tgt_lang))}
            ),
            datalabs.SplitGenerator(
                name=datalabs.Split.VALIDATION,
                gen_kwargs={
                    "f_path": os.path.join(f_path, "dataset_CrossSum/{}-{}_val.jsonl".format(src_lang, tgt_lang))}
            ),
            datalabs.SplitGenerator(
                name=datalabs.Split.TEST,
                gen_kwargs={
                    "f_path": os.path.join(f_path, "dataset_CrossSum/{}-{}_test.jsonl".format(src_lang, tgt_lang))}
            ),
        ]
