...
_DESCRIPTION = """\
We have collected a corpus of data from natural meetings that occurred at the International Computer Science Institute (ICSI) in Berkeley, 
California over the last three years. The corpus contains audio recorded simultaneously from head-worn and table-top microphones, 
word-level transcripts of meetings, and various metadata on participants, meetings, and hardware. 
The ICSI Meeting Corpus is widely used in meeting summarization.
...
class ICSIConfig(datalabs.BuilderConfig):
    """BuilderConfig for ICSIConfig."""
    ...
    def __init__(self, task_templates, **kwargs):
        ...
        """
        super(ICSIConfig, self).__init__(**kwargs)
        self.task_templates = task_templates


class ICSIDataset(datalabs.GeneratorBasedBuilder):
    """ICSI Dataset."""
