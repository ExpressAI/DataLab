...
_TRAIN_DOWNLOAD_URL="https://cdatalab1.oss-cn-beijing.aliyuncs.com/dialogue/xiaohuangji/xiaohuangji.tsv"

class Xiaohuangji(datalabs.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        return datalabs.DatasetInfo(
            ...
            homepage="https://github.com/candlewill/Dialog_Corpus",
            citation=_CITATION,
            languages = ["zh"],
            task_templates=[
