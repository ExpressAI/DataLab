...
_TRAIN_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/text_matching/CNSE/train.txt"
_TEST_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/text_matching/CNSE/test.txt"
...
class CNSE(datalabs.GeneratorBasedBuilder):
    ...
    def _info(self):
        return datalabs.DatasetInfo(
            ...
            citation=_CITATION,
            languages=["zh"],
            task_templates=[get_task(TaskType.text_pair_classification)(
                text1_column="text1",
                text2_column="text2",
                label_column="label"),
            ],
    ...
    def _generate_examples(self, filepath):
        with open(filepath, encoding="utf-8") as file:
            ...
            for id_, row in enumerate(csv_reader):
                ...
                if label == ('0' or '1'):
                    yield id_, {
                        "text1": text1, "text2": text2, "title1": title1, "title2": title2, "keywords1": keywords1, "keywords2": keywords2, 
                        "main_keywords1": main_keywords1, "main_keywords2": main_keywords2, "ner_keywords1": ner_keywords1, "ner_keywords2": ner_keywords2, 
                        "ner1": ner1, "ner2": ner2, "label": label
                    }
