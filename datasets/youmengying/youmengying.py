...
_LICENSE = "MIT"
_TRAIN_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/poetry/youmengying.json"


class YouMengYing(datalabs.GeneratorBasedBuilder):
