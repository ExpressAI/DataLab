...
This task is one of the basic tasks in sentiment analysis, and the dataset covers data scraped on Mafengwo.
...
_LICENSE = "http://cdatalab1.oss-cn-beijing.aliyuncs.com/conditional_generation/cote/COTE-MFW/License.pdf"

_TRAIN_DOWNLOAD_URL = "http://cdatalab1.oss-cn-beijing.aliyuncs.com/conditional_generation/cote/COTE-MFW/train.tsv"
# _TEST_DOWNLOAD_URL = "http://cdatalab1.oss-cn-beijing.aliyuncs.com/conditional_generation/cote/COTE-MFW/test.tsv"
