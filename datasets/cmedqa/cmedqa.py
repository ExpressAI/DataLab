...
_TRAIN_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/question_answering/cMedQA/train.txt"
_VALIDATION_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/question_answering/cMedQA/dev.txt"
_TEST_DOWNLOAD_URL = "https://cdatalab1.oss-cn-beijing.aliyuncs.com/question_answering/cMedQA/test.txt"
    ...
    def _generate_examples(self, filepath):
        ...
        with open(filepath, encoding="utf-8") as f:
            for id_, row in enumerate(f):
                ...
                yield id_, {'text1': example[1], 'text2': example[2], 'label': example[0]}
