...
_TRAIN_DOWNLOAD_URL="https://cdatalab1.oss-cn-beijing.aliyuncs.com/dialogue/chatterbot/chatterbot.tsv"

class Chatterbot(datalabs.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        return datalabs.DatasetInfo(
            ...
            homepage="https://chatterbot-corpus.readthedocs.io/en/latest/",
            citation=_CITATION,
            languages = ["zh"],
            task_templates=[
