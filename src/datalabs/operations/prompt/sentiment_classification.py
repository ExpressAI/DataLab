...
@sentiment_classification_prompting(name="template_p1", contributor="datalab", processed_fields=['text', 'label'],
...
@sentiment_classification_prompting(name="template_p2", contributor="datalab", processed_fields=['text', 'label'],
...
@sentiment_classification_prompting(name="template_p3", contributor="datalab", processed_fields=['text', 'label'],
...
@sentiment_classification_prompting(name="template_p4", contributor="datalab", processed_fields=['text', 'label'],
...
@sentiment_classification_prompting(name="template_p5", contributor="datalab", processed_fields=['text', 'label'],
...
@sentiment_classification_prompting(name="template_p6", contributor="datalab", processed_fields=['text', 'label'],
