...
from datalab.filesystems.hffilesystem import HfFileSystem
...
def resolve_patterns_locally_or_by_urls(
    ...
    Examples:
        ...
        >>> import huggingface_hub
        >>> from datalab.data_files import resolve_patterns_locally_or_by_urls
        >>> base_path = "."
...
def resolve_patterns_in_dataset_repository(
    ...
    Examples:
        ...
        >>> import huggingface_hub
        >>> from datalab.data_files import resolve_patterns_in_dataset_repository
...
class DataFilesDict(Dict[str, DataFilesList]):
    ...
    def __reduce__(self):
        ...
        >>> from datalab.data_files import DataFilesDict
